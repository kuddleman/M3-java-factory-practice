public class AddressOld {
    ...
    I can't get all the combinations of possible information to
       make the constructors I want
     */
    ...
    public AddressOld(String number, String street, String street2, String city,
    ...
    // no street2
    public AddressOld (String number, String street, String city, String state,
